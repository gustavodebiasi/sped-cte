...
class Make extends BaseMake
{
    ...
    private $rodo = '';
    /**
     * Informações do tipo de fretamento
     * @var \DOMNode
     */
    ...
    public function montaCTeOS()
    {
        ...
        if ($this->infCteComp != '') { // Caso seja um CTe tipo complemento de valores
            ...
            if ($this->infModal != '') {
                ...
                $this->dom->appChild($this->infModal, $this->rodo, 'Falta tag "rodo"');
                if ($this->infFretamento != '') {
                    $this->dom->appChild($this->rodo, $this->infFretamento, 'Falta tag "rodo"');
                }
            }
        }
    ...
    /**
     * Gera as tags para o elemento: "infRespTec" (Informações do responsável técnico)
     * #1
     * Nível: 0
     * @param string $cnpj
     ...
     * @return DOMElement|\DOMNode
     */
    public function infRespTecTag($cnpj = '', $xContato = '', $email = '', $fone = '')
    {
        $identificador = '#1 <infRespTec> - ';
        ...
        $this->dom->addChild(
            ...
            $cnpj,
            true,
            $identificador . 'CNPJ do responsável técnico'
        );
        $this->dom->addChild(
            $this->infRespTec,
            'xContato',
        ...
        $this->dom->addChild(
            ...
            $email,
            true,
            $identificador . 'E-mail da pessoa a ser contatada'
        );
        $this->dom->addChild(
            $this->infRespTec,
            'fone',
            $fone,
            true,
            $identificador . 'Telefone da pessoa a ser contatada'
        );
    ...
    /**
     * Leiaute - Rodoviário
     * Gera as tags para o elemento: "infFretamnto" (Informações do modal Rodoviário) CT-e OS
     * #1
     * Nível: 0
     * @param string $tpFretamento
     * @param string $dhViagem
     * @return DOMElement|\DOMNode
     */
    public function infFretamentoTag($tpFretamento = '', $dhViagem = '')
    {
        $identificador = '#1 <infFretamento> - ';
        ...
        $this->dom->addChild(
            ...
            $tpFretamento,
            false,
            $identificador . 'Tipo de fretamento de pessoas'
        );
        if ($tpFretamento == 1) {
            $this->dom->addChild(
                $this->infFretamento,
